...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String targetReachedBody(String team, int set) {
    return '$team reached the target.\n\nSet $set is won.';
  }

  @override
  String get targetReachedKeepPlaying => 'Keep Playing';

  @override
  String get sideSwapLabel => 'Side swap';

  @override
  String get sideSwapNone => 'No side swap';
  ...
  @override
  String get kotcCourtLabel => 'Court';

  @override
  String get kotcStrikeOff => 'No strike';
  ...
  @override
  String get kotcEjectChallengerShort => 'Eject\nChallenger';
  ...
  @override
  String get scrambleExportScorecard => 'Export scorecard';

  @override
  String get scrambleExportResult => 'Export result';

  @override
  String get scrambleExportGame => 'Export game';

  @override
  String get scrambleImportResult => 'Import result';

  @override
  String get scrambleQrScanHint => 'Scan this code on the other device.';
  ...
  @override
  String get scrambleScanTitle => 'Scan QR code';
  ...
  @override
  String get scrambleScanResultHint => 'Point the camera at a result QR code.';
  ...
  @override
  String get scrambleOpenSettings => 'Open settings';

  @override
  String get scrambleScanToImport => 'Scan to import';

  @override
  String get scrambleScanNotScorecard => 'This QR code is not a scorecard.';
  ...
  String scrambleImportSuccess(String name) {
    return 'Imported scorecard from “$name”.';
  }

  @override
  String scrambleImportedTitle(int count) {
    return 'Imported Scorecards ($count)';
  }

  @override
  String get scrambleImportedFilterHint => 'Filter by tournament';

  @override
  String get scrambleImportedEmpty => 'No imported scorecards match.';

  @override
  String get scrambleImportedDeleteAllTitle => 'Delete all imported?';

  @override
  String scrambleImportedDeleteAllBody(int count) {
    return 'This will remove all $count imported scorecard(s).';
  }
  ...
  @override
  String get scrambleStatusScheduled => 'Scheduled';
  ...
  @override
  String get scrambleTabHistory => 'History';

  @override
  String get scrambleTabImported => 'Imported';

  @override
  String get scrambleBackToHub => 'Back to Hub';

  @override
  String get scrambleImportedScorecard => 'Imported Scorecard';
  ...
  String overviewSettingsLockedRounds(int count) {
    return 'Rounds 1–$count are already underway and won\'t change.';
  }

  @override
  String overviewSettingsRoundsRemoved(int from, int to) {
    return 'Rounds $from–$to will be removed.';
  }

  @override
  String overviewSettingsRoundsAdded(int count) {
    return '$count more round(s) will be added.';
  }
  ...
  String overviewSettingsCourtsBlocked(int count) {
    return 'Only $count court(s) can be filled with the current players — reduce courts or add players.';
  }

  @override
  String get overviewSettingsConfirmTitle => 'Apply these changes?';
  ...
  @override
  String get rosterDownloadTemplate => 'Download template';

  @override
  String get rosterImport => 'Import players…';

  @override
  String get rosterExport => 'Export players…';

  @override
  String get rosterMenuInfo => 'About';

  @override
  String get rosterNothingToExport => 'There are no players to export yet.';

  @override
  String get rosterImportTitle => 'Import roster';
  ...
  @override
  String get rosterImportNoChanges => 'No changes were found in this file.';
  ...
  String rosterImportSummary(
    ...
    return '$created added · $updated updated · $teamsCreated new teams · $groupsCreated new groups';
  }
  ...
  String rosterImportDeleteWarning(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count players will be permanently deleted:',
      one: '1 player will be permanently deleted:',
    );
    return '$_temp0';
  }
  ...
  @override
  String get rosterImportConfirm => 'Import';

  @override
  String get rosterImportConfirmDelete => 'Delete & import';
