...
class _DoghouseHubPageState extends State<DoghouseHubPage> {
  ...
  static String _statusLabel(DoghouseTournament t) => switch (t.status) {
  ...
  static String _dateLabel(DoghouseTournament t) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const TournaQAppBar(title: 'Doghouse'),
      body: Column(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Row(
            children: [
              Icon(Icons.pets_rounded, color: Colors.white, size: 22),
              SizedBox(width: 8),
              Text(
                'Doghouse',
                style: TextStyle(
