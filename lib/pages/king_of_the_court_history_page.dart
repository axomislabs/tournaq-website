...
class KingOfTheCourtHistoryPage extends StatelessWidget {
  final KingOfTheCourtTournament tournament;

  const KingOfTheCourtHistoryPage({super.key, required this.tournament});
  ...
  Widget _buildSummaryBar() {
    return Container(
      ...
      child: Row(children: [
        _chip(Icons.emoji_events_rounded, tournament.name,
  ...
  Widget _buildGameCard(KotcGame game, int number) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: won ? _kGoldCardBg : Colors.white,
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              height: 32,
              decoration: BoxDecoration(
                color: won ? _kGold : Colors.grey.shade100,
              ...
              child: Center(
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: won ? Colors.white : Colors.black45,
                  ),
                ),
              ),
            ),
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    ...
                    height: 1.0,
                    color: won ? _kGold : Colors.black87,
                  ),
                ),
                Text(
                  'pts',
                  style: TextStyle(
                    ...
                    color: won ? _kGold : Colors.black38,
                  ),
                ),
                if (won) ...[
                  const SizedBox(height: 4),
