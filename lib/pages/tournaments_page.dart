...
class _TournamentsPageState extends State<TournamentsPage> {
  ...
  void _openQuickGames() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) =>
            GamesPage(appState: _localState, onAppStateChanged: _updateState),
      ),
    );
  }
    ...
    showDialog<void>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () =>
                openExternalUrl(ctx, AppLinks.modeGamesAndTournaments),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              // ── Quick Games ────────────────────────────────────────────
              _sectionHeader(
                l10n.tournamentsSectionQuickGames,
              ...
              Row(
                ...
                children: [
                  _sectionHeader(
                    l10n.tournamentsSectionHistory,
              ...
              _HistoryShortcutTile(
                ...
                onTap: () =>
                    _openHistory(filter: TournamentFilter.kingOfTheCourt),
              ),
              const SizedBox(height: 6),
              _HistoryShortcutTile(
              ...
              _HistoryShortcutTile(
                ...
                onTap: () =>
                    _openHistory(filter: TournamentFilter.scrambleKing),
              ),
            ],
          ),
        ),
