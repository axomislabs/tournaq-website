...
'm-royal-duo-hub': {
  ...
  blocks:[
    ...
    shot('guide/05_royal_duo/03_setup_full',430,1381,[430, 645],
    ...
    shot('guide/05_royal_duo/20_teams_sheet',430,1101,[430, 645],
      'The duos',
...
'm-royal-duo-run': {
  ...
  blocks:[
    ...
    shot('guide/05_royal_duo/04_overview',430,932,[430, 860],
      ...
      'A running Royal Duo'),
    shot('guide/05_royal_duo/06_overview_by_court',430,1873,[430, 645],
      'Read it by court',
...
'm-royal-duo-score': {
  ...
  blocks:[
    ...
    shot('guide/05_royal_duo/07_court_manual_assigning',430,1867,[430, 645],
    ...
    shot('guide/05_royal_duo/09_court_manual_running',430,1867,[430, 645],
    ...
    shot('guide/05_royal_duo/11_court_automated',430,2071,[430, 645],
    ...
    shot('guide/05_royal_duo/13_court_allplay',430,1814,[430, 645],
      'Auto All-Play',
...
'm-league-hub': {
  ...
  blocks:[
    ...
    shot('guide/08_league/03_setup_full',430,1033,[430, 645],
      'The whole setup page',
      'Every choice on one screen, scrolled out in full. Defaults are already sensible — in practice you set the people, the courts and the time, and leave the rest alone.',
...
'm-league-run': {
  ...
  blocks:[
    ...
    shot('guide/08_league/06_schedule_by_round',430,2930,[430, 645],
...
'm-league-score': {
  ...
  blocks:[
    ...
    shot('guide/08_league/08_scorecard',430,1010,[430, 645],
...
'm-elimination-hub': {
  ...
  blocks:[
    ...
    shot('guide/09_elimination_single/03_setup_full',430,1084,[430, 645],
      'The whole setup page',
      'Every choice on one screen, scrolled out in full. Defaults are already sensible — in practice you set the people, the courts and the time, and leave the rest alone.',
...
'm-elimination-score': {
  ...
  blocks:[
    ...
    fbox('i-check','Which card this is','The classic scorecard — sets, target points and side switches. The same one every team competition uses.'),
    shot('guide/09_elimination_single/07_scorecard',430,1040,[430, 645],
      'The scorecard, top to bottom',
      'A best-of-three match part-way through: the first set decided, the second one running under the thumbs, the third still to come. Tap a set in the strip to look back at it without losing the live score.',
...
'm-classic-hub': {
  ...
  blocks:[
    ...
    shot('guide/11_tournaq_classic/03_setup_full',430,1763,[430, 645],
      'The whole setup page',
      'Every choice on one screen, scrolled out in full. Defaults are already sensible — in practice you set the people, the courts and the time, and leave the rest alone.',
...
'm-classic-run': {
  ...
  blocks:[
    ...
    shot('guide/11_tournaq_classic/10_standings_table',430,1010,[430, 645],
      'Group standings',
...
'm-classic-score': {
  ...
  blocks:[
    ...
    fbox('i-check','Which card this is','The classic scorecard — sets, target points and side switches. The same one every team competition uses.'),
    shot('guide/11_tournaq_classic/07_scorecard',430,1010,[430, 645],
      'The scorecard, top to bottom',
      'A best-of-three match part-way through: the first set decided, the second one running under the thumbs, the third still to come. Tap a set in the strip to look back at it without losing the live score.',
...
'm-swiss-hub': {
  ...
  blocks:[
    ...
    shot('guide/12_swiss_system/03_setup_full',430,1088,[430, 645],
      'The whole setup page',
      'Every choice on one screen, scrolled out in full. Defaults are already sensible — in practice you set the people, the courts and the time, and leave the rest alone.',
...
'm-swiss-run': {
  ...
  blocks:[
    ...
    shot('guide/12_swiss_system/10_standings_table',430,2333,[430, 645],
      'The table',
...
'm-swiss-score': {
  ...
  blocks:[
    ...
    fbox('i-check','Which card this is','The classic scorecard — sets, target points and side switches. The same one every team competition uses.'),
    shot('guide/12_swiss_system/07_scorecard',430,1040,[430, 645],
      'The scorecard, top to bottom',
      'A best-of-three match part-way through: the first set decided, the second one running under the thumbs, the third still to come. Tap a set in the strip to look back at it without losing the live score.',
...
'm-social-scramble-hub': {
  ...
  blocks:[
    ...
    shot('guide/03_social_scramble/03_setup_full',430,999,[430, 645],
      'The whole setup page',
      'Every choice on one screen, scrolled out in full. Defaults are already sensible — in practice you set the people, the courts and the time, and leave the rest alone.',
...
'm-social-scramble-run': {
  ...
  blocks:[
    ...
    shot('guide/03_social_scramble/06_overview_by_court',430,1436,[430, 645],
      'Read it by court',
...
'm-social-scramble-score': {
  ...
  blocks:[
    ...
    shot('guide/03_social_scramble/07_scorecard',430,1354,[430, 645],
      'The scorecard, top to bottom',
    ...
    shot('guide/03_social_scramble/20_scorecard_time_up',430,1286,[430, 645],
      'Full time',
    ...
    shot('guide/03_social_scramble/17_splash_game_complete',430,1286,[430, 645],
      'The recap',
    ...
    shot('guide/03_social_scramble/19_sheet_next_game',430,1286,[430, 645],
    ...
    shot('guide/03_social_scramble/23_sheet_tournament_complete',430,989,[430, 645],
    ...
    shot('guide/03_social_scramble/24_scorecard_pace',430,1346,[430, 645],
...
'm-royal-rotation-hub': {
  ...
  blocks:[
    ...
    shot('guide/04_royal_rotation/03_setup_full',430,1265,[430, 645],
      'The whole setup page',
      'Every choice on one screen, scrolled out in full. Defaults are already sensible — in practice you set the people, the courts and the time, and leave the rest alone.',
...
'm-royal-rotation-run': {
  ...
  blocks:[
    ...
    shot('guide/04_royal_rotation/06_overview_by_court',430,1507,[430, 645],
      'Read it by court',
      'The same session grouped by court.',
    ...
    shot('guide/04_royal_rotation/26_overview_pace_overdue',430,1169,[430, 645],
...
'm-royal-rotation-score': {
  ...
  blocks:[
    ...
    shot('guide/04_royal_rotation/07_court_manual_assigning',430,2039,[430, 645],
      'Manual: choosing who comes on',
      'With manual assignment nobody is seated for you. The card offers the fairest pairings it can find on the left and the whole queue on the right — one tap on a suggestion starts that side immediately.',
    ...
    shot('guide/04_royal_rotation/09_court_manual_running',430,2039,[430, 645],
      'Manual: the court running',
      'Once a side is seated the picker gives way to the score. There is no challenger queue here — in manual assignment you decide who comes on next, so the card shows only the game in front of you.',
    ...
    shot('guide/04_royal_rotation/11_court_automated',430,2177,[430, 645],
      'Automated: the queue picks',
      'Automated assignment fills the chain for you: who is on court, who challenges next, who is up after them. Re-roll if a pairing looks wrong, and the rest of the queue shuffles up behind it.',
    ...
    shot('guide/04_royal_rotation/13_court_allplay',430,1814,[430, 645],
      'Auto All-Play',
      'All-Play adds a third tier and a scorekeeper drawn from outside the rotation, so everyone at the court has a job. It needs a fuller court than the other two modes — the queue is longer by a whole side.',
    ...
    shot('guide/04_royal_rotation/24_scorecard_pace',430,2147,[430, 645],
...
'm-royal-shuffle-hub': {
  ...
  blocks:[
    ...
    shot('guide/06_royal_shuffle/03_setup_full',430,1223,[430, 645],
      'The whole setup page',
      'Every choice on one screen, scrolled out in full. Defaults are already sensible — in practice you set the people, the courts and the time, and leave the rest alone.',
...
'm-royal-shuffle-run': {
  ...
  blocks:[
    ...
    shot('guide/06_royal_shuffle/06_overview_by_court',430,1387,[430, 645],
      'Read it by court',
      'The same session grouped by court.',
...
'm-royal-shuffle-score': {
  ...
  blocks:[
    ...
    shot('guide/06_royal_shuffle/11_court_automated',430,1186,[430, 645],
      'Automated: the queue picks',
      'Automated assignment fills the chain for you: who is on court, who challenges next, who is up after them. Re-roll if a pairing looks wrong, and the rest of the queue shuffles up behind it.',
    ...
    shot('guide/06_royal_shuffle/13_court_allplay',430,1188,[430, 645],
      'Auto All-Play',
      'All-Play adds a third tier and a scorekeeper drawn from outside the rotation, so everyone at the court has a job. It needs a fuller court than the other two modes — the queue is longer by a whole side.',
...
'm-doghouse-hub': {
  ...
  blocks:[
    ...
    shot('guide/07_doghouse_shuffle/03_setup_full',430,1223,[430, 645],
      'The whole setup page',
      'Every choice on one screen, scrolled out in full. Defaults are already sensible — in practice you set the people, the courts and the time, and leave the rest alone.',
...
'm-doghouse-run': {
  ...
  blocks:[
    ...
    shot('guide/07_doghouse_shuffle/06_overview_by_court',430,1420,[430, 645],
      'Read it by court',
      'The same session grouped by court.',
...
'm-doghouse-score': {
  ...
  blocks:[
    ...
    shot('guide/07_doghouse_shuffle/11_court_automated',430,1330,[430, 645],
      'Automated: the queue picks',
      'Automated assignment fills the chain for you: who is on court, who challenges next, who is up after them. Re-roll if a pairing looks wrong, and the rest of the queue shuffles up behind it.',
    ...
    shot('guide/07_doghouse_shuffle/13_court_allplay',430,1274,[430, 645],
      'Auto All-Play',
      'All-Play adds a third tier and a scorekeeper drawn from outside the rotation, so everyone at the court has a job. It needs a fuller court than the other two modes — the queue is longer by a whole side.',
...
'quick-game-score': {
  ...
  inbox:[
    ...
    shot('guide/02_quick_game/02_games_full',430,1123,[430, 645],
      'Your history',
